# ==============================================================================
# AUTOMATED OEM BRANDING & CHROOT CODE INJECTION HOOK
# ==============================================================================
echo "-> Integrating dynamic OEM branding and chroot automation..."
...
BRANDING_DIR="/etc/penguins-eggs.d/installer.d/branding/eggs"
...
while true; do
    if [ -d "\$BRANDING_DIR" ] && [ -f "\$RUNNER_FILE" ] && [ -f "\$RUNNER_CONF" ]; then
